describe( "Public Method Tests", function() {
    ...
    describe( "slider constructor", function() {
        it( "reads and sets the 'id' attribute of the slider instance that is created", function() {
            ...
            var sliderInstanceHasExpectedId = $( "#testSlider1" ).next( "div.slider" ).is( "#" + sliderId );
        ...
        it( "generates multiple slider instances from selector", function() {
            ...
            var sliderInstancesExists = $( ".makeSlider" ).next().is( ".slider" );
        ...
        it( "reads and sets the 'orientation' option properly", function() {
            ...
            var orientationClassApplied = $( "#testSlider1" ).next( "div.slider" ).hasClass( "slider-vertical" );
        ...
        it( "reads and sets the 'selection' option properly", function() {
            ...
            var sliderSelectionWidthAtMaxValue = $( "#testSlider1" ).siblings( "div.slider" ).find( "div.slider-track" ).children( "div.slider-selection" ).width();
        ...
        it( "reads and sets the 'handle' option properly", function() {
            ...
            var handleIsSetToTriangle = $( "#testSlider1" ).siblings( "div.slider" ).find( "div.slider-track" ).children( "div.slider-handle" ).hasClass( "triangle" );
        ...
        it( "reads and sets the 'reversed' option properly", function() {
            ...
            var sliderSelectionHeightAtMaxValue = $( "#testSlider1" ).siblings( "div.slider" ).find( "div.slider-track" ).children( "div.slider-selection" ).width();
    ...
    describe( "'isEnabled()' tests", function() {
        ...
        it( "returns false for a disabled slider", function() {
            ...
            var isEnabled = testSlider.slider( "isEnabled" );
            var hasDisabledClass = testSlider.next( 'div' ).hasClass( "slider" ) && testSlider.next( 'div.slider' ).hasClass( "slider-disabled" );
            expect( isEnabled ).not.toBeTruthy();
