describe( "Element Data Attributes Tests", function() {
    ...
    it( "reads the 'data-slider-orientation' property and sets it on slider", function() {
        ...
        var orientationClassApplied = $( "#orientationSlider" ).next( "div.slider" ).hasClass( "slider-vertical" );
    ...
    it( "reads the 'data-slider-selection' property and sets it on slider", function() {
        ...
        var sliderSelectionWidthAtMaxValue = $( "#selectionSlider" ).siblings( "div.slider" ).find( "div.slider-track" ).children( "div.slider-selection" ).width();
    ...
    it( "reads the 'data-slider-handle' property and sets it on slider", function() {
        ...
        var handleIsSetToTriangle = $( "#handleSlider" ).siblings( "div.slider" ).find( "div.slider-track" ).children( "div.slider-handle" ).hasClass( "triangle" );
    ...
    it( "reads the 'data-slider-reversed' property and sets it on slider", function() {
        ...
        var sliderSelectionHeightAtMaxValue = $( "#reversedSlider" ).siblings( "div.slider" ).find( "div.slider-track" ).children( "div.slider-selection" ).width();
    ...
    it( "changes the 'data-slider-orientation' property from horizontal to vertical", function() {
        ...
        var $slider = $( "#changeOrientationSlider" ).next( "div.slider" );
