...
html
  head
    link(type='text/css', rel='stylesheet', href='../bower/jasmine/lib/jasmine-core/jasmine.css')
    block css
  ...
  body
    ...
    block scripts
        script(src='../bower/jasmine/lib/jasmine-core/jasmine.js')
